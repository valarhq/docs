...
<Note>
  Valar offers two completion windows: **Now** (`asap`) for interactive work and **Standard** (`standard`) for cheaper, latency-tolerant work. See [Inference modes](/inference-modes#completion-windows) for how to choose between them.
</Note>
