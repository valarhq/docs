...
<Note>
  To confirm what your API key can reach in a given environment at runtime, call `GET /v1/models` against that environment rather than relying on this table alone.
</Note>