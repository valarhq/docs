---
title: "Models"
description: "Every model ValarAI currently serves"
---
...
* Every row points to the precise Hugging Face checkpoint ValarAI serves. When multiple quantizations are available, each appears as its own model ID.
* Call [`GET /v1/models`](/api-reference/models-api/list-supported-models) against your target environment to verify what's available at runtime for your API key.
* Rates broken down per model and completion window live on the [Pricing](/pricing) page.
