...
Realtime works across the [Responses API](/api-reference/responses-api/create-a-response) (`/v1/responses`) and [Chat Completions](/api-reference/chat-completions-api/create-a-chat-completion) (`/v1/chat/completions`). Use it for interactive chat, prototyping, and human-in-the-loop steps.
