...
Realtime uses the [Responses API](/api-reference/responses-api/create-a-response) (`/v1/responses`). Use it for interactive chat, prototyping, and human-in-the-loop steps.
