...
Realtime uses the **Now** window. Async uses the **Standard** window for lower cost (and Batch will, once available). See [Completion windows](/completion-windows) and [Pricing](/pricing).
