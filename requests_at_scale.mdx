...
<Note>
  **Coming soon.** The Batch API isn't generally available yet. Until it ships, fan out through the [Responses API](#fan-out-with-the-responses-api) with `background=True` for large workloads.
</Note>
