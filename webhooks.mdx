...
<ParamField path="metadata.completion_webhook_token" type="string">
  ...
  <Step title="Submit a request that points at your endpoint">
    ...
    response = client.responses.create(
        ...
        metadata={
            ...
            "completion_webhook_token": "whk_3f0a9c2e7b14",
        },
    )
    ```
...
<ResponseField name="Authorization" type="header">
  Present only when `completion_webhook_token` was set. Carries `Bearer <completion_webhook_token>`.
</ResponseField>
